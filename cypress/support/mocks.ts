export const MOCK_POKEMON_LIST = {
  "count": 10,
  "next": null,
  "previous": null,
  "results": [
    {
      "name": "bulbasaur mocked",
    ...
    {
      "name": "venusaur mocked",
      "url": "https://pokeapi.co/api/v2/pokemon/3/"
    },
    {
      "name": "charmander mocked",
      "url": "https://pokeapi.co/api/v2/pokemon/4/"
    },
    {
      "name": "charmeleon mocked",
      "url": "https://pokeapi.co/api/v2/pokemon/5/"
    },
    {
      "name": "charizard mocked",
      "url": "https://pokeapi.co/api/v2/pokemon/6/"
    },
    {
      "name": "squirtle mocked",
      "url": "https://pokeapi.co/api/v2/pokemon/7/"
    },
    {
      "name": "wartortle mocked",
      "url": "https://pokeapi.co/api/v2/pokemon/8/"
    },
    {
      "name": "blastoise mocked",
      "url": "https://pokeapi.co/api/v2/pokemon/9/"
    },
    {
      "name": "caterpie mocked",
...
export const FIREBASE_SUCCESSFUL_LOGIN_MOCK = {
  user: {
    uid: '0ntOMSV1qTbihLFhTXFW7qTTHKY2',
    email: 'some-email@provider.example',
    emailVerified: true,
    isAnonymous: false,
    providerData: [
      {
    ...
    metadata: {
      creationTime: 'Mon, 01 Jan 2025 00:00:00 GMT',
      lastSignInTime: 'Mon, 01 Jan 2025 00:00:00 GMT',
    },
  },
  providerId: 'firebase',
...
export const FIREBASE_SUCCESSFUL_API_RESPONSE_MOCK = {
  kind: "identitytoolkit#VerifyPasswordResponse",
  email: "some-email@provider.example",
  idToken: "sometoken1234567",
  refreshToken: "asdasdsad",
  expiresIn: "3600",
  localId: "asddasdasdas",
  emailVerified: true,
  displayName: null,
  photoUrl: null,
};

export const FIREBASE_USER_LOOKUP_API_RESPONSE_MOCK = {
  ...
  users: [{
    ...
    providerUserInfo: [{
      providerId: "firebase",
      email: "some-email@provider.example",
      federatedId: "some-email@provider.example",
    }],
    photoUrl: "https://www.example.com/some-photo.jpg",
    lastLoginAt: "1111011500111",
    createdAt: "1111011500111",
  }],
};
